...
export const MEMBER_ROSTER: RosterMember[] = [
  ...
  { name: "Akiola Emmanuel", ward: "Ake Ward" },
  ...
  // --- Camp Ward ---
  { name: "Adeosun Oyinlola", ward: "Camp Ward" },
  { name: "Ateru Princess", ward: "Camp Ward" },
  { name: "Bankole Bolariwa", ward: "Camp Ward" },
  { name: "Egunjobi Bukola", ward: "Camp Ward" },
  { name: "Essiet Samson", ward: "Camp Ward" },
  { name: "Essiet Udo", ward: "Camp Ward" },
  { name: "Iduwe Mercy", ward: "Camp Ward" },
  { name: "Ogunbiyi Oluwatobiloba", ward: "Camp Ward" },
  { name: "Ogunsola Boluwatife", ward: "Camp Ward" },
  { name: "Ogunsola Ifeoluwa", ward: "Camp Ward" },
  { name: "Olawale Sunday", ward: "Camp Ward" },
  { name: "Omoyele Boluwatife", ward: "Camp Ward" },
  { name: "Sosanya Mubarak", ward: "Camp Ward" },
  ...
  // --- Odeda ---
  { name: "Ajayi Grace", ward: "Odeda Ward" },
  { name: "Ajayi Peace", ward: "Odeda Ward" },
  { name: "Elijah Okiki Emmanuel", ward: "Odeda Ward" },
  { name: "Gabriel Jolaoluwa", ward: "Odeda Ward" },
  { name: "Gabriel Oluwapelumi", ward: "Odeda Ward" },
  { name: "Kabiru Abayomi Abass", ward: "Odeda Ward" },
  { name: "Mathew Samuel", ward: "Odeda Ward" },
  { name: "Ogwo Monday Joseph", ward: "Odeda Ward" },
  { name: "Okita Gift Omagbo", ward: "Odeda Ward" },
  { name: "Okita Patience Ote", ward: "Odeda Ward" },
  { name: "Oluwasegun Gift", ward: "Odeda Ward" },
  { name: "Oluwasegun Oluwatobiloba", ward: "Odeda Ward" },
  { name: "Samuel Gabriel Anu", ward: "Odeda Ward" }
];

export const MOCK_RECORDS = [
  { id: '1', full_name: 'Omode Bamidele', phone_number: '08012345678', ward: 'Kuto Ward', date: '2024-01-05', timestamp: 1704441600000 },
  { id: '2', full_name: 'Essiet Udo', phone_number: '08123456789', ward: 'Camp Ward', date: '2024-01-05', timestamp: 1704441600000 },
